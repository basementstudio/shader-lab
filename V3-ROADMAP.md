...
| Posteriores | Halos de color (6.1 #3, incluye los destellos en cruz de 04), Frequency modulation, Retrato de puntos conectados, Relieve grabado (6.1 #5, puede usar profundidad de 6.4) | 5 |
...
**Halos de color implementados como Color Halos (23 de septiembre de 2026), pendiente de prueba del usuario.** Capa de efecto **Color Halos** (catálogo Core, tras Lumen Print), con rol `transform` para que el halo supere el borde de la forma: máscara de brillo (Glow From: formas oscuras, claras o Cutout, con Threshold), campo difuso a resolución reducida con dos iteraciones gaussianas separables (divisor según Spread), mapeado por una rampa editable (Intensity, Fade, Bands con bordes suavizados), Keep Shape que redibuja la forma nítida encima, y destellos en cruz desde puntos brillantes pequeños (Flare, Flare Length, Flare Threshold, Flare Color). Cuatro estilos: Gradient Maps (por defecto, referencia 08), Aura, Cross Flare (04) y Contour Bands. Referencias 08 y 04 revisadas con renders: el halo no se veía fuera del texto (rol de efecto), el desenfoque disperso dejaba ondas y rayas verticales, y los destellos lavaban el cielo; se corrigieron con rol transform, doble iteración, filtro de caja en la máscara y fuentes de destello puntuales. Gradient Maps reproduce las letras nítidas con núcleo rojo/naranja y borde azul; Cross Flare, las cruces naranjas sobre papel celeste. [Prueba manual](tests/composition/COLOR-HALOS-MANUAL-QA.md).
