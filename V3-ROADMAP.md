...
**Máscaras animables (23 de septiembre de 2026, pedidas por el usuario para el barrido de contornos):** Center, Size (Near / Far en la forma Depth), Rotation y Feather de la máscara se exponen al timeline como pistas de parámetro con clave `mask.*`, con botón de keyframe junto a cada control, valores evaluados en editor y runtime, y enlaces de audio. El barrido: dos keyframes en **Mask Near / Far** y la franja térmica recorre el sujeto de delante a atrás.
