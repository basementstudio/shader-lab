...
References 08 and 04 were reopened for a Color Halos prototype. The user tested it, kept only the cross flares (their own skull composition: thin orange crosses with white cores on the eye, nose and teeth highlights) and asked to drop the halos, which did not pair well with the flares. The layer became Flares: the Cross style reproduces that composition's rays; Star, Starburst, Asterisk and Anamorphic vary the ray count, secondary lengths, jitter and color. First renders showed dotted rays and a nested-loop index clash; both were fixed. User visual acceptance of the reworked layer is pending.
