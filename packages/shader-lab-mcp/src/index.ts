...
Layer model: layers render in array order — index 0 first (base of the chain), each later layer composites/applies on top of everything before it. Effects transform the composite below them; sources generate imagery.
