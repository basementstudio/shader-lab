...
const connectedDotsParams = [
  ...
  },
  {
    ...
    type: "select",
    description:
      "Graph links neighbors by tone; Blobs melts dark areas into organic shapes; Plexus draws thin lines that fade with distance; Mesh fills the triangles between points.",
  },
  {
  ...
  },
  {
    ...
    group: "Links",
    visibleWhen: { key: "mode", notEquals: "graph" },
    key: "lineWidth",
    label: "Line Width",
    max: 6,
    min: 0.25,
    ...
    type: "number",
    description:
      "Plexus and mesh line width, in document pixels.",
  },
  {
    defaultValue: dotsDefaults.meshFill as number,
    group: "Mesh",
    visibleWhen: { key: "mode", equals: "mesh" },
    key: "meshFill",
    label: "Fill",
    max: 1,
    min: 0,
    step: 0.01,
    type: "number",
    description: "Opacity of the flat-colored triangles.",
  },
  {
    defaultValue: dotsDefaults.wire as number,
    group: "Mesh",
    visibleWhen: { key: "mode", equals: "mesh" },
    key: "wire",
    label: "Wire",
    ...
    step: 0.01,
    type: "number",
    description: "Opacity of the triangle edges.",
  },
  {
    defaultValue: dotsDefaults.wireColor as string,
    group: "Mesh",
    visibleWhen: { key: "mode", equals: "mesh" },
    key: "wireColor",
    label: "Wire Color",
...
const plotterParams = [
  ...
  },
  {
    ...
    type: "number",
    description:
      "Distance between strokes, in document pixels.",
  },
  {
    defaultValue: 1.5,
    key: "weight",
    ...
    type: "number",
    description:
      "Width of the pen, in document pixels.",
  },
  {
    defaultValue: 0.5,
    key: "pressure",
    ...
    type: "number",
    description:
      "Strokes get wider in dark areas, like pressing harder.",
  },
  {
    defaultValue: 0.5,
    key: "threshold",
    ...
    type: "number",
    description:
      "Tone where the darker layers start (hatch), or how much is left blank.",
  },
  {
    defaultValue: 4,
    key: "smoothing",
  ...
  },
  {
    ...
    type: "boolean",
    visibleWhen: { key: "mode", equals: "hatch" },
    description: "Adds crossing layers in the darker tones.",
  },
  {
    defaultValue: 135,
    group: "Hatch",
  ...
  },
  {
    defaultValue: 8,
    group: "Contour",
    visibleWhen: { key: "mode", equals: "contour" },
    key: "levels",
    label: "Levels",
    max: 60,
    min: 1,
    ...
    type: "number",
    description:
      "Number of contour lines between black and white.",
  },
  {
    defaultValue: 0.45,
    group: "Squiggle",
    visibleWhen: { key: "mode", equals: "squiggle" },
    key: "amplitude",
    label: "Amplitude",
    max: 1,
    min: 0,
    ...
    type: "number",
    description:
      "How far the line swings in dark areas.",
  },
  {
    defaultValue: 0.5,
    group: "Squiggle",
    ...
    type: "number",
    description:
      "Waves per row spacing: higher values make tighter waves.",
  },
  {
    defaultValue: [0, 0] as [number, number],
    group: "Spiral",
    ...
    step: 0.01,
    type: "vec2",
    visibleWhen: { key: "mode", equals: "spiral" },
  },
  {
    defaultValue: 0.3,
    group: "Pen",
    ...
    type: "number",
    description:
      "Hand-drawn wander of the strokes.",
  },
  {
    defaultValue: 0.3,
    group: "Pen",
    ...
    type: "number",
    description:
      "Soft ink edges and uneven ink along the strokes.",
  },
  {
    defaultValue: "ink",
    group: "Pen",
    ...
    options: [
      { label: "Ink", value: "ink" },
      { label: "Source", value: "source" },
      { label: "Three pens", value: "pens" },
    ],
    type: "select",
    description: "Three pens draws each hatch layer with its own color.",
  },
  {
    defaultValue: "#1a1a1a",
    group: "Pen",
    ...
    label: "Ink Color",
    type: "color",
    visibleWhen: { key: "colorMode", notEquals: "source" },
  },
  {
    defaultValue: "#d8452f",
    group: "Pen",
    ...
    label: "Pen 2",
    type: "color",
    visibleWhen: { key: "colorMode", equals: "pens" },
  },
  {
    defaultValue: "#2f5fd8",
    group: "Pen",
