...
import { MODEL_LAYER_INTERNAL_VISIBILITY } from "@/lib/editor/model-layer/shared"
import type {
  EffectLayerType,
  LayerDefinition,
  LayerKind,
...
const modelParams = [
  {
    ...
    type: "select",
    visibleWhen: MODEL_LAYER_INTERNAL_VISIBILITY,
  },
  {
    animatable: false,
    defaultValue: "",
  ...
  },
  {
    defaultValue: 1,
    description:
      "Scales the active light rig for brighter or moodier reflections.",
  ...
  },
  {
    ...
    options: [
      ...
      { label: "Liquid Chrome", value: "liquid" },
    ],
    type: "select",
    visibleWhen: {
      equals: "custom",
