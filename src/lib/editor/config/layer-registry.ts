...
const asciiParams = [
  ...
  {
    defaultValue: 0,
    description: "0 follows the font's own character aspect.",
    group: "Grid",
    key: "cellAspect",
    label: "Cell Aspect",
    max: 2,
  ...
  },
  {
    ...
    defaultValue: "ramp",
    description:
      "Ramp maps brightness to a character. Structure matches each cell's shape against every glyph. Contour draws edges with directional characters.",
    group: "Glyph",
    key: "glyphSource",
    label: "Glyph Source",
    options: [
      ...
      { label: "Contour + Structure", value: "contour-structure" },
    ],
    type: "select",
  },
  {
  ...
  },
  {
    ...
    defaultValue: true,
    description:
      "Orders the characters by how much ink each one has in the chosen font, so any charset reads dark to light.",
    group: "Glyph",
    key: "autoSortCharset",
    label: "Auto-sort Charset",
    type: "boolean",
  },
  {
    defaultValue: 0.08,
    group: "Glyph",
    key: "contourThreshold",
  ...
  },
  {
    defaultValue: 0.06,
    description:
      "Cells flatter than this fall back to the ramp instead of shape matching.",
    group: "Glyph",
    key: "structureContrast",
    label: "Structure Floor",
    max: 0.5,
    min: 0.001,
    step: 0.001,
    type: "number",
  ...
  },
  {
    ...
    group: "Grid",
    key: "glyphScaleSource",
    label: "Size From",
    options: [
      { label: "Luminance", value: "luminance" },
      { label: "Inverse Luminance", value: "inverse" },
      { label: "Colour Signal", value: "color" },
    ],
    type: "select",
    visibleWhen: {
      gte: 0.001,
  ...
  },
  {
    defaultValue: 0,
    description:
      "Carries characters with the moving image instead of re-picking every frame, which is what stops ASCII video crawling.",
    group: "Life",
    key: "advection",
    label: "Advection",
    max: 1,
  ...
  },
  {
    defaultValue: 0,
    description:
      "Movement scrambles and flares the characters it passes through.",
    group: "Life",
    key: "motionScramble",
    label: "Motion Scramble",
    max: 1,
    min: 0,
    step: 0.01,
    type: "number",
  ...
  {
    defaultValue: 0.85,
    description: "How long a scrambled character keeps flaring.",
    group: "Life",
    key: "scrambleDecay",
    label: "Scramble Decay",
    max: 0.99,
    min: 0,
    step: 0.01,
    type: "number",
