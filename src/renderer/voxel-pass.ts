...
export class VoxelPass extends PassNode {
  ...
  protected override buildEffectNode(): Node {
    ...
    // Face mask (Y-down: top vertex of hex is at ly = -s)
    // Top face if ly < -|lx| / sqrt(3); else right if lx > 0; else left
    ...
    // Light-flip swaps right/left shades
    ...
    // Side: bounded above by bottom arc of top ellipse, below by bottom arc of base ellipse.
    const tNorm = clamp(
    ...
    // Outline = hex perimeter only (cube silhouette). No internal edges.
